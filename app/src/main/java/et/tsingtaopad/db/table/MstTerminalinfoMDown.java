 ...
 * 用于筛选 下载终端
 *
 * MstTerminalinfoMDown entity. @author MyEclipse Persistence Tools
 */
@DatabaseTable(tableName = "MST_TERMINALINFO_M_DOWN")
public class MstTerminalinfoMDown implements java.io.Serializable {
	...
	/** default constructor */
	public MstTerminalinfoMDown() {
	}

	/** minimal constructor */
	public MstTerminalinfoMDown(String terminalkey) {
		this.terminalkey = terminalkey;
	}

	public MstTerminalinfoMDown(String terminalkey, String terminalname, String sequence ) {
		this.terminalkey = terminalkey;
	...
	/** full constructor */
	public MstTerminalinfoMDown(String terminalkey, String routekey, String terminalcode, String terminalname, String province, String city,
