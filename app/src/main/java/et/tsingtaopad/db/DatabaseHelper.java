...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    private Dao<MitMorningmeetingM, String> mitMorningmeetingMDao = null;
    ...
    public Dao<MitMorningmeetingM, String> getMitMorningmeetingMDao() throws SQLException {

        if (mitMorningmeetingMDao == null) {
            mitMorningmeetingMDao = getDao(MitMorningmeetingM.class);
        }
        return mitMorningmeetingMDao;
    }
