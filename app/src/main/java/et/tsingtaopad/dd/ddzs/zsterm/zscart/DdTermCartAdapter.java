 ...
 */
public class DdTermCartAdapter extends BaseAdapter implements View.OnLongClickListener {
    ...
    public DdTermCartAdapter(Activity context, List<XtTermSelectMStc> seqTermList,
                             List<XtTermSelectMStc> termialLst, RelativeLayout confirmBt, String termId, String type, IClick listener) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            // holder.visitDateTv = (TextView) convertView.findViewById(R.id.item_termcart_tv_visitdate);// 拜访时间汇总 (废弃)
        ...
        if ("3".equals(item.getStatus())) {
            ...
            /*holder.terminalRb.setOnClickListener(listener);
            holder.terminalRb.setTag(position);*/
            holder.itermLayout.setOnClickListener(listener);
