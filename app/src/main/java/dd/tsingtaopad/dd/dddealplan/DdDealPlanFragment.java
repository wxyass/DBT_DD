package dd.tsingtaopad.dd.dddealplan;
...
import dd.tsingtaopad.dd.dddealplan.make.DdDealMakeFragment;
import dd.tsingtaopad.dd.dddealplan.remake.DdReDealMakeFragment;
...
public class DdDealPlanFragment extends BaseFragmentSupport implements View.OnClickListener {
    ...
    private void initView(View view) {
        ...
        monthplan_lv = (dd.tsingtaopad.view.NoScrollListView) view.findViewById(R.id.zgjh_monthplan_lv);
