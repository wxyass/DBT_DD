...
public class ProCheckFragment extends BaseFragmentSupport implements View.OnClickListener {
    ...
    private dd.tsingtaopad.view.NoScrollListView procheck_lv;
    ...
    private void initView(View view) {
        ...
        procheck_lv = (dd.tsingtaopad.view.NoScrollListView) view.findViewById(R.id.operation_procheck_procheck_lv);
