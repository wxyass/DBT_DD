...
import dd.tsingtaopad.dd.dddaysummary.adapter.ProCheckAdapter;
import dd.tsingtaopad.dd.dddaysummary.domain.DaySummaryStc;
import dd.tsingtaopad.dd.dddaysummary.domain.DdProCheckItemStc;
import dd.tsingtaopad.dd.dddaysummary.domain.DdProCheckShowStc;
import dd.tsingtaopad.dd.dddaysummary.domain.DdProCheckStc;
...
public class ProPriceFragment extends BaseFragmentSupport implements View.OnClickListener {
    ...
    private dd.tsingtaopad.view.NoScrollListView proprice_lv;
    ...
    private void initView(View view) {
        ...
        proprice_lv = (dd.tsingtaopad.view.NoScrollListView) view.findViewById(R.id.operation_proprice_monthplan_lv);
