...
import dd.tsingtaopad.dd.dddaysummary.adapter.DdPromotionAdapter;
import dd.tsingtaopad.dd.dddaysummary.domain.DaySummaryStc;
import dd.tsingtaopad.dd.dddaysummary.domain.DdPromotionStc;
...
public class PromotionFragment extends BaseFragmentSupport implements View.OnClickListener {
    ...
    private void initView(View view) {
        ...
        monthplan_lv = (dd.tsingtaopad.view.NoScrollListView) view.findViewById(R.id.operation_promotion_monthplan_lv);
