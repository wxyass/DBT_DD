...
import dd.tsingtaopad.dd.dddaysummary.adapter.AgencyStoreAdapter;
import dd.tsingtaopad.dd.dddaysummary.domain.AgencyStoreItemStc;
import dd.tsingtaopad.dd.dddaysummary.domain.AgencyStoreShowStc;
import dd.tsingtaopad.dd.dddaysummary.domain.AgencyStoreStc;
...
public class AgencyStoreFragment extends BaseFragmentSupport implements View.OnClickListener {
    ...
    private void initView(View view) {
        ...
        monthplan_lv = (dd.tsingtaopad.view.NoScrollListView) view.findViewById(R.id.operation_agencystore_monthplan_lv);
