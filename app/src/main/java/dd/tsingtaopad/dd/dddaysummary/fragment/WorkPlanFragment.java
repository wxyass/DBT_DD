...
import dd.tsingtaopad.dd.dddaysummary.adapter.WorkPlanAdapter;
import dd.tsingtaopad.dd.dddaysummary.domain.DaySummaryStc;
import dd.tsingtaopad.dd.dddaysummary.domain.DdDayPlanStc;
...
public class WorkPlanFragment extends BaseFragmentSupport implements View.OnClickListener {
    ...
    private void initView(View view) {
        ...
        monthplan_lv = (dd.tsingtaopad.view.NoScrollListView) view.findViewById(R.id.operation_workplan_monthplan_lv);
