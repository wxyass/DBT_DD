...
import dd.tsingtaopad.dd.dddaysummary.adapter.CmpProAdapter;
import dd.tsingtaopad.dd.dddaysummary.domain.CmpProItemStc;
import dd.tsingtaopad.dd.dddaysummary.domain.CmpProShowStc;
import dd.tsingtaopad.dd.dddaysummary.domain.CmpProStc;
...
public class CmpProFragment extends BaseFragmentSupport implements View.OnClickListener {
    ...
    private dd.tsingtaopad.view.NoScrollListView monthplan_lv;
    ...
    private void initView(View view) {
        ...
        monthplan_lv = (dd.tsingtaopad.view.NoScrollListView) view.findViewById(R.id.operation_cmppro_monthplan_lv);
