...
import dd.tsingtaopad.dd.ddagencyres.DdAgencySelectService;
...
public class DdAgencyCheckSelectFragment extends BaseFragmentSupport implements View.OnClickListener {
    ...
    private void initView(View view) {
        ...
        areaBtn = (dd.tsingtaopad.core.view.dropdownmenu.DropdownButton) view.findViewById(R.id.agency_check_ddb_area);
