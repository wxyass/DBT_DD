package dd.tsingtaopad.dd.ddzs.zsinvoicing.zsinvocingtz;
...
public class ZsInvoicingTzAdapter extends
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.valueLv = (dd.tsingtaopad.view.NoScrollListView)convertView.findViewById(R.id.item_zs_invoicing_tz_lv);// 进货量
    ...
    private class ViewHolder {
        ...
        private dd.tsingtaopad.view.NoScrollListView valueLv;
    }
