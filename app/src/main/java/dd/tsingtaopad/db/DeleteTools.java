...
import dd.tsingtaopad.db.table.CmmAreaM;
import dd.tsingtaopad.db.table.CmmBoardM;
import dd.tsingtaopad.db.table.CmmDatadicM;
import dd.tsingtaopad.db.table.MstAgencygridInfo;
import dd.tsingtaopad.db.table.MstAgencyinfoM;
import dd.tsingtaopad.db.table.MstAgencysupplyInfo;
import dd.tsingtaopad.db.table.MstAgencytransferInfo;
import dd.tsingtaopad.db.table.MstAgencyvisitM;
import dd.tsingtaopad.db.table.MstBrandsclassM;
import dd.tsingtaopad.db.table.MstBrandseriesM;
import dd.tsingtaopad.db.table.MstCenterM;
import dd.tsingtaopad.db.table.MstCenterdetailsM;
import dd.tsingtaopad.db.table.MstCheckaccomplishInfo;
import dd.tsingtaopad.db.table.MstCheckcollectionInfo;
import dd.tsingtaopad.db.table.MstCheckexerecordInfo;
import dd.tsingtaopad.db.table.MstCheckexerecordInfoTemp;
import dd.tsingtaopad.db.table.MstCheckmiddleInfo;
import dd.tsingtaopad.db.table.MstCheckstatusInfo;
import dd.tsingtaopad.db.table.MstChecktypeM;
import dd.tsingtaopad.db.table.MstCmpagencyInfo;
import dd.tsingtaopad.db.table.MstCmpareaInfo;
import dd.tsingtaopad.db.table.MstCmpbrandsM;
import dd.tsingtaopad.db.table.MstCmpcompanyM;
import dd.tsingtaopad.db.table.MstCmproductinfoM;
import dd.tsingtaopad.db.table.MstCmpsupplyInfo;
import dd.tsingtaopad.db.table.MstCollectionexerecordInfo;
import dd.tsingtaopad.db.table.MstCollectionitemM;
import dd.tsingtaopad.db.table.MstGridM;
import dd.tsingtaopad.db.table.MstInvalidapplayInfo;
import dd.tsingtaopad.db.table.MstInvoicingInfo;
import dd.tsingtaopad.db.table.MstMarketareaM;
import dd.tsingtaopad.db.table.MstMonthtargetInfo;
import dd.tsingtaopad.db.table.MstPlanWeekforuserM;
import dd.tsingtaopad.db.table.MstPlancheckInfo;
import dd.tsingtaopad.db.table.MstPlancollectionInfo;
import dd.tsingtaopad.db.table.MstPlanforuserM;
import dd.tsingtaopad.db.table.MstPlanrouteInfo;
import dd.tsingtaopad.db.table.MstPlantempcheckInfo;
import dd.tsingtaopad.db.table.MstPlantempcollectionInfo;
import dd.tsingtaopad.db.table.MstPlantemplateM;
import dd.tsingtaopad.db.table.MstPowerfulchannelInfo;
import dd.tsingtaopad.db.table.MstPowerfulterminalInfo;
import dd.tsingtaopad.db.table.MstPriceM;
import dd.tsingtaopad.db.table.MstPricedetailsInfo;
import dd.tsingtaopad.db.table.MstProductM;
import dd.tsingtaopad.db.table.MstProductareaInfo;
import dd.tsingtaopad.db.table.MstProductshowM;
import dd.tsingtaopad.db.table.MstPromomiddleInfo;
import dd.tsingtaopad.db.table.MstPromoproductInfo;
import dd.tsingtaopad.db.table.MstPromotermInfo;
import dd.tsingtaopad.db.table.MstPromotionsM;
import dd.tsingtaopad.db.table.MstPromotionstypeM;
import dd.tsingtaopad.db.table.MstQuestionsanswersInfo;
import dd.tsingtaopad.db.table.MstRouteM;
import dd.tsingtaopad.db.table.MstShipmentledgerInfo;
import dd.tsingtaopad.db.table.MstShowpicInfo;
import dd.tsingtaopad.db.table.MstSynckvM;
import dd.tsingtaopad.db.table.MstTerminalinfoM;
import dd.tsingtaopad.db.table.MstVisitM;
import dd.tsingtaopad.db.table.MstVisitauthorizeInfo;
import dd.tsingtaopad.db.table.MstVisitmemoInfo;
import dd.tsingtaopad.db.table.MstVistproductInfo;
import dd.tsingtaopad.db.table.MstWorksummaryInfo;
import dd.tsingtaopad.db.table.PadCheckaccomplishInfo;
import dd.tsingtaopad.db.table.PadCheckproInfo;
import dd.tsingtaopad.db.table.PadCheckstatusInfo;
import dd.tsingtaopad.db.table.PadChecktypeM;
import dd.tsingtaopad.db.table.PadPlantempcheckM;
import dd.tsingtaopad.db.table.PadPlantempcollectionInfo;
